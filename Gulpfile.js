...
gulp.task('clean:pot', function() {
  return del(['languages/buntpress.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
  ...
  .pipe(wpPot({
    domain: 'buntpress',
    destFile:'buntpress.pot',
    package: 'buntpress',
    bugReport: 'http://buntport.com',
    lastTranslator: 'John Doe <mail@buntport.com>',
    team: 'Team <mail@buntport.com>'
  }))
...
gulp.task('watch', function() {
  ...
  browserSync({
    ...
    proxy: "testing.dev",         // Use http://buntport.com:3000 to use BrowserSync
    watchOptions: {
